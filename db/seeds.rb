...
history = Project.create(name: "History", description: "A project about world's history")
art = Project.create(name: "Art", description: "A project about art")
biology = Project.create(name: "Biology", description: "A project about human biology")
spanish = Project.create(name: "Spanish", description: "A project about the Spanish language")
