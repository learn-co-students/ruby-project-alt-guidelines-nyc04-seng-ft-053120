...
a1=" CANCELED ".colorize(:color => :white, :background => :red)
b1=" COMPLETED ".colorize(:color => :white, :background => :green)
table = TTY::Table.new [ 'DONATIONS'.colorize(:color => :green), 'Name','status...','Distance'], [['masks','Donat',b1,'74 km']]
table1 = TTY::Table.new [ 'DONATIONS'.colorize(:color => :green), 'Name','status...','Distance'], [['masks','Donat',a1,'74 km']]
...
animation()
system("clear")
puts "                              What's your name                        ?".colorize(:color => :white, :background => :red)
emri=gets.chomp
system("clear")
...
puts""
puts ds.asciify("     "+emri).colorize(ngjyra[ffr])
sleep (0.3)
system("clear")
ffr+=1
end
...
sleep(0.3)
puts""
puts"   ".colorize(:color => :white, :background => :red)+"    SECOND DONATION  ".colorize(:background=>:blue)
puts table.render(:unicode,indent:8, padding: [0,1,0,1],resize: true)
sleep(0.3)
puts""
puts"   ".colorize(:color => :white, :background => :red)+"     THIRD DONATION  ".colorize(:background=>:blue)
puts table1.render(:unicode,indent:8,  width:50, padding: [0,1,0,1],resize: true)
puts""
